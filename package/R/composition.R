...
#'
#' @param body_height Body height in centimeters
#' @param abdominal_circumference Abdominal circumference in centimeters.
#' @param neck_circumference Neck circumference in centimeters.
...
body_fat <- function(body_height, abdominal_circumference, neck_circumference, sex = c('male', 'female')) {
  if(sex == 'female') {
    ...
    value <- 19.197 - 0.239 * body_height +
